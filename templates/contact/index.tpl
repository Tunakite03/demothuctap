                    ...
                    <div class="bg-secondary text-white d-flex flex-column justify-content-center h-100 p-5">
                        ...
                        <div class="d-flex pt-2">
                            <a class="btn btn-square btn-outline-light rounded-circle me-1"
                                href="https://twitter.com/Nhathuy23345359"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-square btn-outline-light rounded-circle me-1"
                                href="https://www.facebook.com/profile.php?id=100035728604896"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square btn-outline-light rounded-circle me-1"
                                href="https://www.youtube.com/channel/UCrVHPRWgu4yBybfkheWNJqw"><i
                                    class="fab fa-youtube"></i></a>
                            <a class="btn btn-square btn-outline-light rounded-circle me-0"
                                href="https://www.linkedin.com/in/huy-nguy%E1%BB%85n-%C4%91o%C3%A0n-nh%E1%BA%ADt-a76019218/"><i
                                    class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <h5 class="display-5 mb-3">Góp ý / Phản hồi</h5>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message"
                                        name="message" required style="height: 420px"></textarea>
                                    <label for="message">Tin nhắn...</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-secondary rounded-pill py-3 px-5" type="submit"
                                    name="SubmitMessage">Gửi tin
                                    nhắn</button>
                            </div>
                        </div>
                    </form>
