<section class="content-section px-5">
    <div class="payment-confirm" style="text-align: center; width: 90%; margin: auto; padding: 20px">
        <h3>Bạn đã đặt hàng thành công</h3>
        <p>Chúc tôi đã nhận được yêu cầu đặt đơn hàng của bạn, đơn hàng của bạn đang được xử lý và sẽ nhanh chóng giao
